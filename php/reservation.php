                        ...
                        <form method="post" action="traitement_reservation.php">
                            ...
                            <div class="row mb-3">
                                <div class="col-md-6">
                                    ...
                                    <input type="time" id="heure_acces" name="heure_acces" class="form-control" required>
                                </div>
                                <div class="col-md-6">
                                    <label for="heure_rendu" class="form-label">Heure de rendu :</label>
                                    <input type="time" id="heure_rendu" name="heure_rendu" class="form-control" required>
                                </div>
                            </div>
                            <div class="mb-3">
